package com.lwkandroid.bluetoothkit.utils;
...
public class BluetoothUtils
{
    ...
    public static String getLocalAddress()
    {
        ...
        {
            //6.0以上系统获取到的都是“02:00:00:00:00:00”
            ...
            try
            {
                ...
                {
                    address = (String) btManagerService.getClass().getMethod("getAddress")
                            .invoke(btManagerService).toString();
                }
